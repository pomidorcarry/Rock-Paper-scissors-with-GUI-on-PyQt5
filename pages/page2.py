...
class Page2(QWidget):
    ...
    def initUI_grid_layout(self, grid_layout: QGridLayout):
        ...
        self.picture_rock.setPixmap(
            QPixmap((self.resource_path("assets/picture_3.jpg")))
        )
        self.picture_paper.setPixmap(
            QPixmap((self.resource_path("assets/picture_2.jpg")))
        )
        self.picture_scissors.setPixmap(
            QPixmap((self.resource_path("assets/picture_4.jpg")))
        )
